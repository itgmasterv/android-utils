...
public final class CrashUtils {
    ...
    static {
        try {
            PackageInfo pi = context_.getPackageManager().getPackageInfo(context_.getPackageName(), 0);
            if (pi != null) {
    ...
    public static void init(final String crashDir) {
        ...
        if (Environment.MEDIA_MOUNTED.equals(Environment.getExternalStorageState())
                && context_.getExternalCacheDir() != null)
            defaultDir = context_.getExternalCacheDir() + FILE_SEP + "crash" + FILE_SEP;
        else {
            defaultDir = context_.getCacheDir() + FILE_SEP + "crash" + FILE_SEP;
        }
