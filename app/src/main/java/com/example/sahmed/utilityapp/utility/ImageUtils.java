...
public final class ImageUtils {
     ...
     * @return bitmap
     */
    public static Bitmap getBitmap(@DrawableRes final int resId, final int maxWidth, final int maxHeight,Context context) {
        BitmapFactory.Options options = new BitmapFactory.Options();
     ...
     * @param newWidth  newWidth
     * @param newHeight newHeight
     * @param recycle   Whether to recover
     * @return Zoom the picture
     */
     ...
     * Zoom the picture
     *
     * @param src         Source imageSource image
     * @param scaleWidth  scaleWidth
     * @param scaleHeight scaleHeight
     * @param recycle     Whether to recover
     * @return Zoom the picture
     ...
     *
     * @param src Source image
     * @param kx  Tilt factor x
     * @param ky  Tilt factor y
     * @return Tilted after the picture
     */
     ...
     * @param kx  Tilt factor x
     * @param ky  Tilt factor y
     * @param px  Translation factor x
     * @param py  Translation factor y
     * @return Tilted after the picture
     */
     ...
     * @param px      Rotate the abscissa
     * @param py      Rotation point ordinate
     * @return After the rotation of the picture
     */
    ...
    /**
     * Turn to a circle picture
     *
     * @param src Source image
     * @return Round picture
     */
     ...
     * @param cornerRadius Fillet radius
     * @return Fillet picture
     */
     ...
     * @param borderSize    borderSize
     * @param color       Border color
     * @param isCircle     Whether it is a circle
     * @param cornerRadius Fillet radius
     * @param recycle      Whether to recover
     * @return Border map
     */
     ...
     *
     * @param src             Source image
     * @param reflectionHeight reflectionHeight
     * @return With reflection picture
     */
    ...
    public static Bitmap addReflection(final Bitmap src,
                                       ...
                                       final boolean recycle) {
        if (isEmptyBitmap(src)) return null;
        // The spacing between the original and the reflection
     ...
     *
     * @param src       Source image
     * @param watermark Picture watermark
     * @param x        Starting coordinate x
     * @param y         Starting coordinate y
    ...
    /**
     * Fast blur
     * <p>first shrink the original, the small map of the fuzzy, and then zoom back to the original size </p>
     *
     * @param src    Source image
     * @param scale  scaling (0 ... 1)
     * @param radius blurring radius
     * @return  blurred after the picture
     */
    ...
    /**
     * Quickly blur the picture
     * <p>First shrink the original map, the small map to blur, and then zoom back to the original size</p>
     *
     * @param src     Source image
     * @param scale   scaling (0 ... 1))
     * @param radius  Blurring radius (0 ... 25)
     * @param recycle Whether to recover
    ...
    /**
     * renderScript blurred picture
     * <p>API greater than 17</p>
     *
     * @param src    Source image
     * @param radius Fuzzy radius(0...25)
     * @param recycle
     * @return Blurred picture
     */
    ...
    public static Bitmap renderScriptBlur(final Bitmap src,
        ...
        return renderScriptBlur(src, radius,recycle);
    }
     ...
     *
     * @param src Source image
     * @param radius Fuzzy radius
     * @return stack blurred picture
     */
    ...
    public static boolean save(final Bitmap src, final File file, final Bitmap.CompressFormat format, final boolean recycle) {
        ...
        try {
            ...
            //comment to ignore error create CloseUtils
    ...
    /**
     * Judge whether the file is a picture based on the file name
     *
     * @param file 　file
    ...
    /**
     * Stream to get the picture type
     *
     ...
     * Get the image type
     *
     * @param bytes bitmap of the first 8 bytes
     * @return Picture type
     */
    ...
    /**
     * Determines if the bitmap object is empty
     *
     * @param src Source image
     * @return {@code true}: yes<br>{@code false}: no
     */
    ...
    ///////////////////////////////////////////////////////////////////////////
    // Below is related to compression
    ///////////////////////////////////////////////////////////////////////////
     ...
     * @return Zoom the compressed image
     */
     ...
     *
     * @param src         Source image
     * @param scaleWidth  Zoom the width multiple
     * @param scaleHeight Zoom the height multiple
     * @return Zoom the compressed image
     */
     ...
     * @return Quality compressed image
     */
     ...
     *
     * @param src         Source image
     * @param maxByteSize Allow the maximum number of bytes

     * @return Quality compression compressed picture
     */
    ...
    public static Bitmap compressByQuality(final Bitmap src, final long maxByteSize, final boolean recycle) {
        ...
        byte[] bytes;
        if (baos.size() <= maxByteSize) {// The best quality is not greater than the maximum byte, then return the best quality
            bytes = baos.toByteArray();
        } else {
            baos.reset();
            src.compress(Bitmap.CompressFormat.JPEG, 0, baos);
            if (baos.size() >= maxByteSize) { // The worst quality is not less than the maximum byte, and the worst quality is returned
                bytes = baos.toByteArray();
            } else {
                // Dichotomy to find the best quality
                int st = 0;
                int end = 100;
                int mid = 0;
                while (st < end) {
    ...
    /**
     * Compressed by sample size
     *
     * @param src        Source image
     * @param sampleSize Sampling rate
     * @return Compress the image by sample rate
     */
    ...
    /**
     * Compress the image by sample rate
     *
     * @param src        Source image
     * @param sampleSize Sampling rate
     * @param recycle    Whether to recover
     * @return   Compressed by sample size
     */
