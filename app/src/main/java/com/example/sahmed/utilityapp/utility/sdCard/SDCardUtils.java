 ...
 *     time  : 2016/08/11
 *     desc  :SD card related tools category
 * </pre>
 */
public final class SDCardUtils {
    ...
    /**
     * To determine whether the SD card is available
     *
     * @return true : Available <br>false : unavailable
     */
     ...
     *
     * @param removable true : External SD card<br>false : Built-in SD card
     * @return SD card path
     */
    @SuppressWarnings("TryWithIdenticalCatches")
    public static List<String> getSDCardPaths(boolean removable  , Context context) {
