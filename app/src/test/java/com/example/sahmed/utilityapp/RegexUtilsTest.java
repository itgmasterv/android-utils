...
public class RegexUtilsTest {
    ...
    public void isUsername() throws Exception {
        assertTrue(RegexUtils.isUsername("Komyo233333"));
        assertFalse(RegexUtils.isUsername("Komyo"));
        assertFalse(RegexUtils.isUsername("Komyo233333_"));
    }
